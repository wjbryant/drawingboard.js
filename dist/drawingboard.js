...
DrawingBoard.Control.DrawingMode = DrawingBoard.Control.extend({
	...
	defaults: {
		pencil: true,
		// disable highlighter by default, since the 'darker' composite
		// operation is not supported in all browsers
		highlighter: false,
		eraser: true,
		filler: true
	},
	...
	initialize: function() {
		...
		$.each(["pencil", "highlighter", "eraser", "filler"], $.proxy(function(k, value) {
			if (this.opts[value]) {
